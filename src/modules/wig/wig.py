...
class Wig(object):
	...
	def scan_site(self):
		...
		print('ip: '+ str(self.data['results'].site_info['ip']))
	...
	def get_results(self):
		return self.data['results'].site_info, self.data['results'].results
...
def parse_args(url=None):
	...
	parser.add_argument('-a', action='store_true', dest='run_all', default=True,
		help='Do not stop after the first CMS is detected')

	parser.add_argument('-m', action='store_true', dest='match_all', default=True,
	...
	parser.add_argument('--no_cache_load', action='store_true', default=True,
	...
	parser.add_argument('--verbosity', '-v', action='count', default=3,
	...
	parser.add_argument('-w', dest='output_file', default='results.json',
